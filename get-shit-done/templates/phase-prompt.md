...
<!-- Key rule: Gemini starts dev server BEFORE human-verify checkpoints. User only visits URLs. -->
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>[What Gemini built] - server running at [URL]</what-built>
...
<!-- Checkpoint pattern: Gemini starts server, user visits URL. See checkpoints.md for full patterns. -->
<task type="auto">
