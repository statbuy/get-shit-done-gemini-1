...
Provides a better update experience than raw `npx get-shit-done-gemini` by showing version diff and changelog entries.
</objective>
...
```bash
npm view get-shit-done-gemini version 2>/dev/null
```
...
To update manually: `npx get-shit-done-gemini --global`
```
