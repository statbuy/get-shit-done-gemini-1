...
**Purpose:** Document what Gemini needs to know to implement a phase well - not just "which library" but "how do experts build this."
...
- When Gemini's training data is likely stale or sparse
